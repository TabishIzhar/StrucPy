...
member_details= pd.read_excel('./InputFiles/Example3.xlsx', 'members', header = 0, index_col=0)
nodes_details= pd.read_excel('./InputFiles/Example3.xlsx', 'nodes', header = 0, index_col=0)
boundcond = pd.read_excel('./InputFiles/Example3.xlsx', 'boundary', header = 0, index_col=0)
